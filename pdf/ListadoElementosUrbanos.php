...
$pdf->Cell(40,$alturafila2,utf8_decode('Tipo'),1,0,'L',True);
$pdf->Cell(80,$alturafila2,utf8_decode('Coordenadas '),1,0,'C');
$pdf->Cell(14,$alturafila2,utf8_decode('Cantidad'),1,0,'L',True);
$pdf->Cell(20,$alturafila2,utf8_decode('Fecha.'),1,0,'C');
$pdf->Cell(20,$alturafila2,utf8_decode('Descripcion.'),1,1,'L',True);
